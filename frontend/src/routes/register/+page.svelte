...
<div class="flex items-center pb-80 justify-center h-screen">
    <form method="post" class="w-full max-w-md bg-white shadow-md rounded-md p-6">
        ...
        <div class="mb-4">
            <label class="block text-gray-700 text-sm font-semibold mb-2">
                E-Mail
                <input class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:border-indigo-500" type="email">
            </label>
        </div>
        ...
        <div class="mb-4">
            <label class="block text-gray-700 text-sm font-semibold mb-2">
                Password
                <input bind:value={password} class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:border-indigo-500" type="password">
            </label>
        </div>
        ...
        <div class="mb-4">
            <label class="block text-gray-700 text-sm font-semibold mb-2">
                Repeat Password
                <input bind:value={passwordConfirm} class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:border-indigo-500" type="password">
            </label>
            {#if !passwordValid}
