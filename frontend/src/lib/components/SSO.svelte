<script>
    ...
    const start = () => {
        ...
        google.accounts.id.renderButton(signInWithGoogle,
            { theme: "outline", size: "large", logo_alignment: "center", width: 400 }  // customization attributes
        );
    };
